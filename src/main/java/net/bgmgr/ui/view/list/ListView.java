package net.bgmgr.ui.view.list;

import net.bgmgr.backend.entity.Company;
import net.bgmgr.backend.entity.Contact;
import net.bgmgr.backend.service.CompanyService;
import net.bgmgr.backend.service.ContactService;
import net.bgmgr.ui.MainLayout;
